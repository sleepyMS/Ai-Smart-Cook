...
const Nav = () => {
  ...
  const [vegetableCategoryExpanded, setVegetableCategoryExpanded] = useState(false);
              ...
              {vegetables.map((vegetable, index) => (
                <li key={index}>
                  <Checkbox
                    ...
                    onChange={(checked) => setVegetables(prevVegetables => {
            ...
            <ul className={styles["item-container"]}> {/* item-container 클래스 추가 */}
              {fishes.map((fish, index) => (
                <li key={index}>
                  <Checkbox
                    checked={fish.state}
                    onChange={(checked) => setFishes(prevFishes => {
              ...
              {sources.map((source, index) => (
                <li key={index}>
                  <Checkbox
                    ...
                    onChange={(checked) => setSoures(prevSources => {
             ...
             <ul className={styles["item-container"]}> {/* item-container 클래스 추가 */}
              {grains.map((grain, index) => (
                <li key={index}>
                  <Checkbox
                    checked={grain.state}
                    onChange={(checked) => setGrains(prevGrains => {
